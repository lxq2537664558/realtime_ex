...
class player_base : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.db.player_base) */ {
 public:
  ...
  void clear_vitality();
  static const int kVitalityFieldNumber = 12;
...
// optional uint32 face = 7;
inline bool player_base::has_face() const {
  return (_has_bits_[0] & 0x00000040u) != 0;
}
inline void player_base::set_has_face() {
  _has_bits_[0] |= 0x00000040u;
}
inline void player_base::clear_has_face() {
  _has_bits_[0] &= ~0x00000040u;
}
inline void player_base::clear_face() {
  face_ = 0u;
  clear_has_face();
}
inline ::google::protobuf::uint32 player_base::face() const {
  // @@protoc_insertion_point(field_get:proto.db.player_base.face)
  return face_;
}
inline void player_base::set_face(::google::protobuf::uint32 value) {
  set_has_face();
  face_ = value;
...
// optional uint64 money = 11;
inline bool player_base::has_money() const {
  return (_has_bits_[0] & 0x00000200u) != 0;
}
inline void player_base::set_has_money() {
  _has_bits_[0] |= 0x00000200u;
}
inline void player_base::clear_has_money() {
  _has_bits_[0] &= ~0x00000200u;
}
inline void player_base::clear_money() {
  money_ = GOOGLE_ULONGLONG(0);
  clear_has_money();
}
inline ::google::protobuf::uint64 player_base::money() const {
  // @@protoc_insertion_point(field_get:proto.db.player_base.money)
  return money_;
}
inline void player_base::set_money(::google::protobuf::uint64 value) {
  set_has_money();
  money_ = value;
...
// optional uint64 vitality = 12;
inline bool player_base::has_vitality() const {
  return (_has_bits_[0] & 0x00000400u) != 0;
}
inline void player_base::set_has_vitality() {
  _has_bits_[0] |= 0x00000400u;
}
inline void player_base::clear_has_vitality() {
  _has_bits_[0] &= ~0x00000400u;
}
inline void player_base::clear_vitality() {
  vitality_ = GOOGLE_ULONGLONG(0);
  clear_has_vitality();
}
inline ::google::protobuf::uint64 player_base::vitality() const {
  // @@protoc_insertion_point(field_get:proto.db.player_base.vitality)
  return vitality_;
}
inline void player_base::set_vitality(::google::protobuf::uint64 value) {
  set_has_vitality();
  vitality_ = value;
