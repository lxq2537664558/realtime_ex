...
namespace proto {
namespace db {
class select_commandDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<select_command> {
...
const ::google::protobuf::uint32 TableStruct::offsets[] = {
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(select_command, _has_bits_),
...
static const ::google::protobuf::internal::MigrationSchema schemas[] = {
  { 0, 7, sizeof(select_command)},
};

static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&_select_command_default_instance_),
};
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "select_command.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
void TableStruct::Shutdown() {
  _select_command_default_instance_.Shutdown();
...
void TableStruct::InitDefaultsImpl() {
  ...
  _select_command_default_instance_.DefaultConstruct();
}
...
select_command::select_command()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_select_5fcommand_2eproto::InitDefaults();
  }
  SharedCtor();
...
const ::google::protobuf::Descriptor* select_command::descriptor() {
  protobuf_select_5fcommand_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_select_5fcommand_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}
...
size_t select_command::RequiredFieldsByteSizeFallback() const {
...
::google::protobuf::Metadata select_command::GetMetadata() const {
  protobuf_select_5fcommand_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_select_5fcommand_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
#if LANG_CXX11
void select_command::set_table_name(::std::string&& value) {
  set_has_table_name();
