...
static const ::google::protobuf::internal::MigrationSchema schemas[] = {
  { 0, 14, sizeof(player_base)},
  { 23, 29, sizeof(player_base_set)},
};
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] = {
      ...
      "\013\n\003exp\030\010 \001(\004\022\014\n\004gold\030\t \001(\004:\r\202\265\030\tplayer_i"
      "d\":\n\017player_base_set\022\'\n\010data_set\030\001 \003(\0132\025"
      ".proto.db.player_base"
  };
...
::google::protobuf::uint8* player_base::InternalSerializeWithCachedSizesToArray(
  ...
  // optional uint64 gold = 9;
  if (cached_has_bits & 0x00000100u) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt64ToArray(9, this->gold(), target);
  }
