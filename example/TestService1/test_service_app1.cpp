...
public:
	...
	bool client_request_msg_callback(core::SClientSessionInfo sClientSessionInfo, core::CMessagePtr<SClientRequestMsg> pMessage)
	{
		...
		core::CFuture<core::CMessagePtr<SServiceResponseMsg1>> sResponseFuture;
		bool bRet = core::CClusterInvoker::Inst()->invoke_r(core::CCoreServiceApp::Inst()->getNodeID("test2-1"), &service_msg1, sResponseFuture);
		if (!bRet)
		{
			PrintDebug("AAAAAAAA");
			return true;
		...
		sResponseFuture.then_r([sClientSessionInfo, nSync](core::CMessagePtr<SServiceResponseMsg1> pResultData, uint32_t nErrorCode)
		{
			...
			core::CFuture<core::CMessagePtr<SServiceResponseMsg2>> sResponseFuture;
			bool bRet = core::CClusterInvoker::Inst()->invoke_r(core::CCoreServiceApp::Inst()->getNodeID("test2-1"), &service_msg2, sResponseFuture);
			if (!bRet)
				PrintDebug("BBBBBBBBB");

			return sResponseFuture;

		}).then_r([sClientSessionInfo, nSync](core::CMessagePtr<SServiceResponseMsg2> pResultData, uint32_t nErrorCode)
		{
			...
			core::CFuture<core::CMessagePtr<SServiceResponseMsg3>> sResponseFuture;
			bool bRet = core::CClusterInvoker::Inst()->invoke_r(core::CCoreServiceApp::Inst()->getNodeID("test2-1"), &service_msg3, sResponseFuture);
			if (!bRet)
				PrintDebug("CCCCCCCC");

			return sResponseFuture;

		}).then([sClientSessionInfo, nSync](core::CMessagePtr<SServiceResponseMsg3> pResultData, uint32_t nErrorCode)
		{
