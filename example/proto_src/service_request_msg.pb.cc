...
void protobuf_AssignDesc_service_5frequest_5fmsg_2eproto() {
  ...
  static const int service_request_msg_offsets_[2] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(service_request_msg, name_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(service_request_msg, id_),
  };
...
const int service_request_msg::kIdFieldNumber;
#endif  // !_MSC_VER
