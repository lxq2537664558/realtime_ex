...
// optional uint32 id = 2;
inline bool service_response_msg::has_id() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void service_response_msg::set_has_id() {
  _has_bits_[0] |= 0x00000002u;
}
inline void service_response_msg::clear_has_id() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void service_response_msg::clear_id() {
  id_ = 0u;
  clear_has_id();
}
inline ::google::protobuf::uint32 service_response_msg::id() const {
  // @@protoc_insertion_point(field_get:test.service_response_msg.id)
  return id_;
}
inline void service_response_msg::set_id(::google::protobuf::uint32 value) {
  set_has_id();
  id_ = value;
  // @@protoc_insertion_point(field_set:test.service_response_msg.id)
}
